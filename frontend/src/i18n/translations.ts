...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "admin.orderDetail.pricingLockedMessage": "Pricing is locked after payment or production progress.",
    "admin.orderDetail.subtotalLabel": "Subtotal",
    "admin.orderDetail.totalIncludingDeliveryLabel": "Total (including delivery)",
    "admin.orderDetail.statusHistoryTitle": "Status History",
    "admin.orderDetail.noStatusChangesMessage": "No status changes recorded yet.",
    ...
    "admin.orderDetail.noCommunicationMessage": "No communication has been sent yet.",
  ...
  nl: {
    ...
    "admin.orderDetail.pricingLockedMessage": "Prijzen zijn vergrendeld na betaling of productie voortgang.",
    "admin.orderDetail.subtotalLabel": "Subtotaal",
    "admin.orderDetail.totalIncludingDeliveryLabel": "Totaal (inclusief levering)",
    "admin.orderDetail.statusHistoryTitle": "Status Geschiedenis",
    "admin.orderDetail.noStatusChangesMessage": "Nog geen status wijzigingen geregistreerd.",
    ...
    "admin.orderDetail.noCommunicationMessage": "Nog geen communicatie verzonden.",
