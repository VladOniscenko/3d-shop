...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "forgot.successMessage": "If the account exists, a reset email has been sent.",
    ...
    "admin.orderDetail.trackingUrlPlaceholder": "https://carrier.example/track/...",
    "admin.orderDetail.communication": "Communication",
    "admin.orderDetail.communicationTypeQuoteRequested": "Quote Requested",
    "admin.orderDetail.communicationTypeQuoteConfirmation": "Quote Confirmation + Price",
    "admin.orderDetail.communicationTypeOrderSentTracking": "Order Sent + Track and Trace",
  ...
  nl: {
    ...
    "forgot.successMessage": "Indien het account bestaat, is een reset-e-mail verzonden.",
    ...
    "admin.orderDetail.communicationTypeQuoteConfirmation": "Offerte Bevestiging + Prijs",
    "admin.orderDetail.communicationTypeOrderSentTracking": "Order Verzonden + Track and Trace",
    ...
    "admin.orderDetail.noStatusChanges": "Nog geen status wijzigingen geregistreerd.",
