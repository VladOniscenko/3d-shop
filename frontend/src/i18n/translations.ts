...
export const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    "admin.order.deleteConfirmMessage": "Are you sure you want to delete this order? This action cannot be undone.",
    ...
    "admin.order.emailConfirmationNote": "This email includes the quoted price and final order details.",
    "admin.order.emailTrackingNote": "This email includes tracking information for the shipped order.",
  ...
  nl: {
    ...
    "admin.order.deleteConfirmMessage": "Weet je zeker dat je deze order wilt verwijderen? Deze actie kan niet ongedaan gemaakt worden.",
    ...
    "admin.order.emailConfirmationNote": "Deze e-mail bevat de geoffreerde prijs en definitieve ordergegevens.",
    "admin.order.emailTrackingNote": "Deze e-mail bevat trackinginformatie voor de verzonden order.",
